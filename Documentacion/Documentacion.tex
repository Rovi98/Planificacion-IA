...
En este caso todos los programadores tendran habilidad 1 i todas la tareas dificultad 3. Esto debería probocar que todos ningún prgogramador pueda tener tareas asignadas.
\medskip
\begin{verbatim}
(define (problem test-01) (:domain task)
    (:objects p1 p2 p3 - programador
...
En esta ocasion minimizaremos el tiempo total y el número de programadores. Haciendo pruebas hemos encontrado que una onderación igual nos da buenos resultados, debido a que ambos contadores son parecidos.

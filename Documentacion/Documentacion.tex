...
step    0: ASIGNARDIFICIL P1 T0
        1: REVISAR P2 P1 T0
        2: ASIGNAR P0 T1
        3: REVISAR P2 P0 T1
plan cost: 11.000000
\end{verbatim}
\noindent {\Large \textbf{Justificación}}
...
\end{verbatim}
\subsection{Juegos de prueba}
\subsubsection{Juego de prueba estándard}
{\Large \textbf{Input}}
\medskip
...
\end{verbatim}
\noindent {\Large \textbf{Justifación}}
...
\subsubsection{Juego de prueba imposible de realizar}
\noindent {\Large \textbf{Input}}
